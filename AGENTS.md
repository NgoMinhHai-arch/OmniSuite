...
1. **CHỈ CHỈNH SỬA ĐÚNG YÊU CẦU**: Tuyệt đối không tự ý thay đổi bất kỳ file, hàm hay dòng code nào không nằm trong yêu cầu trực tiếp.
2. **KHÔNG TỰ Ý THAY ĐỔI UI/UX**: Không thay đổi màu sắc, phông chữ, layout, hiệu ứng hoặc "nâng cấp" giao diện trừ khi có yêu cầu cụ thể về việc đó.
